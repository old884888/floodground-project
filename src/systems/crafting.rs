...
pub static RECIPES: &[Recipe] = &[
    ...
    Recipe {
        name: "烤肉",
        ingredients: &[(ItemKind::RawMeat, 1)],
        result: (ItemKind::CookedMeat, 1),
        base_progress: 200,
        requires_fire: true,
        min_light: 0,
        craft_desc: "正在篝火上烤肉...",
        can_interrupt: false,
        desc: "生肉串在木棍上伸向火焰——滋滋作响，油脂滴落。人类学会用火之后的第一顿热饭。",
        requires_tool: None,
    },
    Recipe {
        name: "批量烤肉",
        ingredients: &[(ItemKind::RawMeat, 3)],
        result: (ItemKind::CookedMeat, 3),
        base_progress: 500,
        requires_fire: true,
        min_light: 0,
        craft_desc: "正在批量烤肉...",
        can_interrupt: false,
        desc: "三块肉一起上——篝火够大，你也够饿。省得一块一块翻。",
        requires_tool: None,
    },
    Recipe {
        name: "烤脂肪",
        ingredients: &[(ItemKind::Fat, 1)],
        result: (ItemKind::CookedMeat, 1),
        base_progress: 150,
        requires_fire: true,
        min_light: 0,
        craft_desc: "正在烤脂肪...",
        can_interrupt: false,
        desc: "白花花的脂肪在火上缩成小块肉。滋滋响，满手油——值了。",
        requires_tool: None,
    },
    // 烟熏
    Recipe {
        name: "烟熏肉",
        ingredients: &[(ItemKind::RawMeat, 1)],
        result: (ItemKind::SmokedMeat, 1),
        base_progress: 500,
        requires_fire: true,
        min_light: 0,
        craft_desc: "正在烟熏肉...",
        can_interrupt: false,
        desc: "生肉挂在烟熏架上——烟熏味渗进肉里。能放很久很久。",
        requires_tool: None,
    },
    Recipe {
        name: "搓火",
